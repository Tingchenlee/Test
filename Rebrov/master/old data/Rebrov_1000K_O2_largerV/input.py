...
surfaceReactor(  
    ...
    surfaceVolumeRatio=(2.8571428e3, 'm^-1'), #A/V = 280µm*π*9mm/140µm*140µm*π*9mm = 2.8571428e4^m-1
...
model( 
    toleranceKeepInEdge=0.05, #recommend setting toleranceKeepInEdge to not be larger than 10% of toleranceMoveToCore
