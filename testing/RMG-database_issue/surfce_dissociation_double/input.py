database(
    thermoLibraries=['surfaceThermoPt111', 'primaryThermoLibrary', 'thermo_DFT_CCSDTF12_BAC','DFT_QCI_thermo', 'GRI-Mech3.0-N', 'NitrogenCurran','primaryNS'],
    reactionLibraries = ['Surface/CPOX_Pt/Deutschmann2006','Surface/Nitrogen'], 
    seedMechanisms = [ ],
    kineticsDepositories = ['training'],
    kineticsFamilies = ['Surface_Adsorption_Dissociative_Double'],
