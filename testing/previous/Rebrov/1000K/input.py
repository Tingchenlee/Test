...
database(
    thermoLibraries=['surfaceThermoPt111', 'surfaceThermoNi111', 'primaryThermoLibrary', 'thermo_DFT_CCSDTF12_BAC','DFT_QCI_thermo', 'GRI-Mech3.0-N', 'NitrogenCurran', 'primaryNS', 'CHON', 'CHON_G4'],
    reactionLibraries = ['Surface/CPOX_Pt/Deutschmann2006', 'Surface/Schneider_Pt111', 'Surface/Novell_Pt111', 'Surface/Offermans_Pt111', 'Surface/Scheuer_Pt', 'Surface/Ryan_Pt111', 'Surface/Rebrov_Pt111','Surface/Kraehnert_Pt111','Surface/Vlachos_Ru0001','Surface/Vlachos_Rh','Surface/Vlachos_Pt111', 'Surface/Roldan_Cu111', 'Surface/Roldan_Ir111', 'Surface/Roldan_Ru0001'], 
    seedMechanisms = [],
