...
database(
    ...
    reactionLibraries = ['Surface/CPOX_Pt/Deutschmann2006','Surface/ammoniaCombine','Surface/Ammonia_Ru'], # 'BurkeH2O2inN2', 'ERC-FoundationFuelv0.9', 'GRI-Mech3.0-N', 'Klippenstein_Glarborg2016' when Ni is used change the library to Surface/Deutschmann_Ni 
    seedMechanisms = [],  #'Nitrogen_Glarborg_Gimenez_et_al
