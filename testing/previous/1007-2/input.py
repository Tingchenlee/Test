...
database(
    ...
    reactionLibraries = ['Surface/CPOX_Pt/Deutschmann2006','Surface/ammoniaCombine'], 
    seedMechanisms = ['Surface/Ammonia_Pt211_oxidation'],  
...
catalystProperties(
     bindingEnergies = {  #default value for Pt211
     		            'H':(-2.890, 'eV/molecule'),
                        'C':(-7.205, 'eV/molecule'),
                        'N':(-4.635, 'eV/molecule'),
                        'O':(-4.150, 'eV/molecule'),
