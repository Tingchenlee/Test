database(
    ...
    reactionLibraries = ['Surface/CPOX_Pt/Deutschmann2006','Surface/Ammonia_Fe_BEAzeolite'],  
    seedMechanisms = [],  
...
catalystProperties(
    bindingEnergies = {  # default values for Ru(0001)  NEED valuse of Fe !! 
    		              'H':(-2.85191775E+00, 'eV/molecule'),
                          'C':(-7.59790076E+00, 'eV/molecule'),
                          'N':(-5.96899731E+00, 'eV/molecule'),
                          'O':(-5.44919557E+00, 'eV/molecule'),
                      },
    surfaceSiteDensity=(2.630E-09, 'mol/cm^2'), # Default for Ru(0001)  NEED valuse of Fe !! 
)
